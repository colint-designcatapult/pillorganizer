  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProxyProvider<SelectedDeviceProvider, MedicationsProvider>(
        ...
        builder: (context) => MaterialApp(
          ...
          theme: ThemeData(
              ...
              colorScheme: ColorScheme.fromSeed(
                seedColor: Color(0xff077CAB)
              ),
              appBarTheme: const AppBarTheme(
                  toolbarHeight: 70,
                  titleSpacing: 25,
                  color: Color(0xff077CAB),
              ...
              primaryColor: const Color(0xff077CAB),
              fontFamily: 'Roboto',
