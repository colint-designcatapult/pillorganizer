...
class MedicationEntryStep extends StatelessWidget {
  ...
  static Route<MedicationEntryStep> route(context) =>
      platformPageRoute(context: context, builder:
          (_) => const MedicationEntryStep());
  ...
  Widget build(BuildContext context) {
        return Scaffold(
          body: WizardStep(
            ...
            subtext: 'Enter in the medications you take so your pill organizer can remind you.',
            footer: ElevatedButton(
                onPressed: () {
                  var currentUser = Provider
                      .of<AuthenticationProvider>(context, listen: false).currentUser;
                    ...
                    return Column(
                        ...
                        children: [
                          if((prov.value?.isNotEmpty ?? false)) ... [
                            ...
                            Text('You don\'t have any medications entered yet.')
                          ],
                          TextButton.icon(
                              icon: Icon(Icons.add),
...
class CreateAccountStep extends StatelessWidget {
  ...
  static Route<CreateAccountStep> route(context) =>
      platformPageRoute(context: context, builder:
          (_) => const CreateAccountStep());
