...
class _LoginPageState extends State<LoginPage> {
    ...
    return BasicPage(
      ...
      child: BasicForm(
        ...
        children: [
          ...
          CheckboxListTile(
            title: Text("Engineering: use anonymous account"),
            value: useAnon,
            onChanged: (newValue) {
              setState(() {
  ...
  void _submitForm() {
    ...
    if(!useAnon) {
      ...
      _loginFuture = prov.logInAnonymous(id: int.parse(username!), secret: password!);
    }
    ...
    setState(() {
      _loginFuture!
        ...
        if(err is ProblemJsonException) {
          ...
          _showErrorDialog('There was a problem signing you in: ${err.toString()}');
        }
      });
    });
  }
