...
// Provisioning Service - combines characteristics for WiFi + Fleet Provisioning
using ProvisioningServiceUUID = BleUUID128<0x00,0x00,0x9D,0xAE,0x9D,0x75,0x4C,0x35,0xB8,0x06,0xF8,
                                                0x5B,0x76,0xD8,0xDE,0x20>;
using ProvisioningService = BaseGattService<ProvisioningServiceUUID, SerialNumberCharacteristic, WiFiCredentialsCharacteristic>;
